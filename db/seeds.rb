...
cars = [
  ...
  { description: "Superbe multipla avec une belle piscine", user_id: Antoine.id, km: 1245, year: 2021, price: 250, location: "2 Quai du Port, 13002 Marseille", phase: "Multi Pool" },
  { description: "Voiture 4", user_id: Yannick.id, km: 3670, year: 2004, price: 175, location: "15 Rue Royale, 74000 Annecy", phase: "Multi Snow" },
  { description: "Voiture 5", user_id: Ben.id, km: 60000, year: 2008, price: 214, location: "45 Boulevard Longchamp, 13001 Marseille", phase: "Multi Truck" },
  { description: "Voiture 6", user_id: Anh.id, km: 126000, year: 2000, price: 205, location: "10 Rue de Rivoli, 75004 Paris", phase: "Multi pkm" },
  { description: "Voiture 7", user_id: Antoine.id, km: 46000, year: 2007, price: 201, location: "25 Avenue des Champs-Élysées, 75008 Paris", phase: "Multi Dreamdark" },
